...
def welcome(request:Request,pk):
    if request.user.is_authenticated:
            ...
            for link in __image_link:
                try:
                    ...
                    if width <= 1920 and height <= 972:
                        ...
                        output.save("media/images/"+str(pk)+"/"+str(pk)+"_"+str(i)+".jpg")
                        image_name.append(str(pk)+"_"+str(i)+".jpg")
                        if i == 1:
                            welcome.image1 ="images/"+str(pk)+"/"+str(pk)+"_"+str(i)+".jpg"
                        elif i == 2:
                            welcome.image2 ="images/"+str(pk)+"/"+str(pk)+"_"+str(i)+".jpg"
                        elif i == 3:
                            welcome.image3 ="images/"+str(pk)+"/"+str(pk)+"_"+str(i)+".jpg"
                        elif i == 4:
                            welcome.image4 ="images/"+str(pk)+"/"+str(pk)+"_"+str(i)+".jpg"
                        elif i == 5:
                            welcome.image5 ="images/"+str(pk)+"/"+str(pk)+"_"+str(i)+".jpg"
        ...
        servers = Server.objects.filter(pk=pk).filter(admin__contains=str(request.user.id))
        if servers is None:
